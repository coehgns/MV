...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React16.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React16.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React16.useMemo(() => storageManager == null ? void 0 : storageManager({
  ...
  const [isClient, setIsClient] = React16.useState(noSsr || !isMultiSchemes);
  React16.useEffect(() => {
    setIsClient(true);
  }, []);
  ...
  const handleMediaQuery = React16.useCallback((event) => {
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React17.createContext(void 0);
  if (true) {
    ColorSchemeContext.displayName = "ColorSchemeContext";
  }
  const useColorScheme = () => React17.useContext(ColorSchemeContext) || defaultContext;
  ...
  function CssVarsProvider(props) {
    ...
    const ctx = React17.useContext(ColorSchemeContext);
    const nested = !!ctx && !disableNestedContext;
    const initialTheme = React17.useMemo(() => {
      if (themeProp) {
        return themeProp;
      }
    ...
    const allColorSchemes = React17.useMemo(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React17.Fragment, {
...
function isMuiElement(element, muiNames) {
  var _a, _b, _c;
  return React19.isValidElement(element) && muiNames.indexOf(
  ...
  const Grid2 = React20.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(GridRoot, {
      ...
      children: React20.Children.map(children, (child) => {
        var _a;
        if (React20.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
function joinChildren(children, separator) {
  const childrenArray = React21.Children.toArray(children).filter(Boolean);
...
function useGlobalId(idOverride) {
  const [defaultId, setDefaultId] = React28.useState(idOverride);
...
function useControlled(props) {
  ...
  } = React29.useRef(controlled !== void 0);
  const [valueState, setValue] = React29.useState(defaultProp);
  ...
  const setValueIfUncontrolled = React29.useCallback((newValue) => {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
function useForkRef(...refs) {
  const cleanupRef = React31.useRef(void 0);
  const refEffect = React31.useCallback((instance) => {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RVM7T3JI.js.map
